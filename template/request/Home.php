...
<div class="news-block">
								...
								<div class="news-tab tab-button">
									<button onClick="new Ajax.Updater('notices', 'template/request/notices.php?MyNotices=geral', {method: 'get', asynchronous:true, evalScripts:true}); carregando('#notices');" class="btn-block-n active button-n">Geral</button>
									<button onClick="new Ajax.Updater('notices', 'template/request/notices.php?MyNotices=event', {method: 'get', asynchronous:true, evalScripts:true}); carregando('#notices');" class="btn-block-n button-n">Eventos</button>
									<button onClick="new Ajax.Updater('notices', 'template/request/notices.php?MyNotices=updat', {method: 'get', asynchronous:true, evalScripts:true}); carregando('#notices');" class="btn-block-n button-n">Updates</button>
								
								</div>
								<div name="notices" id="notices"><!--loading notices-->
