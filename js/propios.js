...
{
  document.getElementById(vari).innerHTML="<br /><div class='loading_full' style='font: 12px/16px Arial, sans-serif;'><b>Por favor aguarde enquanto o sistema carrega.....</b></div>";
}
...
function formatresults2()
{
  if (this.timesup == false)
  {
    ...
    var displaystring2 = "<span style='color: rgb(184, 171, 126);'>" + arguments[1] + "h " + arguments[2] + "m " + arguments[3] + "s</span>"
  }
  else
  {
    //else if target date/time met
    var displaystring2 = "<span style='color:#d6e71a;'>NOW!</span>"
  }
